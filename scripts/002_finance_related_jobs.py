"""
AUTHOR: Rohan Joseph
PURPOSE: Execute Stage 2 finance-related job filtering.
...
from pipelines.finance_related import run_finance_related_jobs  # type: ignore
...
def run_stage() -> None:
    """
    Run Stage 2 using the shared runtime configuration and output directory layout.
    ...
    run_finance_related_jobs(config = config, paths = paths)
...
if __name__ == "__main__":
    log_path = capture_script_console_to_markdown(
        ...
        script_name = "002_finance_related_jobs",
