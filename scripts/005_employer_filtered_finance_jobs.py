"""
AUTHOR: Rohan Joseph
PURPOSE: Execute Stage 5 employer-filtered finance jobs.
...
from pipelines.employer_filter import run_employer_filtered_finance_jobs  # type: ignore
...
def run_stage() -> None:
    """
    Run Stage 5 using the shared runtime configuration and output directory layout.
    ...
    run_employer_filtered_finance_jobs(config = config, paths = paths)
...
if __name__ == "__main__":
    log_path = capture_script_console_to_markdown(
        ...
        script_name = "005_employer_filtered_finance_jobs",
