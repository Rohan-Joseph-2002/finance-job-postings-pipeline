"""
AUTHOR: Rohan Joseph
PURPOSE: Execute Stage 4 employer name matching.
...
from pipelines.employer_matching import run_employer_name_matching  # type: ignore
...
def run_stage() -> None:
    ...
    run_employer_name_matching(config = config, paths = paths)
...
if __name__ == "__main__":
    log_path = capture_script_console_to_markdown(
        ...
        script_name = "004_employer_name_matching",
